...
import com.example.breaxcare.model.GeminiPro;
import com.example.breaxcare.model.apiconnection.ResponseCallback;
import com.google.android.material.textfield.TextInputEditText;

public class GeminiAIActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_gemini_aiactivity);
        ...
        sendQueryButton.setOnClickListener(v -> {
            ...
            model.getResponse(query, new ResponseCallback() {
                ...
                public void onError(Throwable throwable) {
                    Toast.makeText(GeminiAIActivity.this, "Error: " + throwable.getMessage(), Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            });
        });
